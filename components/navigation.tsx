      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {mobileMenuOpen && (
          <div className="md:hidden pb-4 space-y-2 animate-in fade-in slide-in-from-top-2">
            <button
              onClick={() => scrollToSection("gallery")}
              className="block w-full text-left px-4 py-2 text-foreground/80 hover:text-accent transition-colors"
            >
              Gallery
            </button>
            <button
            ...
            <a
              href="tel:(786)571-1063"
              className="block w-full px-4 py-2 bg-accent text-background font-medium rounded-lg text-center hover:bg-accent/90 transition-all"
            >
              Book Now
            </a>
          </div>
